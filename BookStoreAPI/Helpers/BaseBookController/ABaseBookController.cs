...
namespace BookStoreAPI.Helpers.BaseBookController
{
    ...
    {
        protected abstract Task<ActionResult<IEnumerable<BookForView>>> GetAllEntitiesAsync();
        ...
        protected virtual async Task<ActionResult<IEnumerable<BookForView>>> GetAllEntitiesCustomAsync() { return null; }
