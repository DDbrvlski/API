        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ISBN10 = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Book_Language_OriginalLanguageID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shipping_ShippingStatus_ShippingStatusID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookImages_Images_ImageID",
                        column: x => x.ImageID,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookItem_Availability_AvailabilityID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Supply_DeliveryStatus_DeliveryStatusID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BookDiscount_BookItem_BookItemID",
                        column: x => x.BookItemID,
                        principalTable: "BookItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookDiscount_Discount_DiscountID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecommendedBooks_BookItem_BookItemID",
                        column: x => x.BookItemID,
                        principalTable: "BookItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rental_BookItem_BookItemID",
                        column: x => x.BookItemID,
                        principalTable: "BookItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rental_RentalStatus_RentalStatusID",
                        column: x => x.RentalStatusID,
                        principalTable: "RentalStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rental_RentalType_RentalTypeID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_BookItem_BookItemID",
                        column: x => x.BookItemID,
                        principalTable: "BookItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockAmount_BookItem_BookItemID",
                        column: x => x.BookItemID,
                        principalTable: "BookItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRecommendedBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserRecommendedBooks_BookItem_BookItemID",
                        column: x => x.BookItemID,
                        principalTable: "BookItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Book_OriginalLanguageID",
                table: "Book",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookDiscount_BookItemID",
                table: "BookDiscount",
                column: "BookItemID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookItem_AvailabilityID",
                table: "BookItem",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookItem_FileFormatID",
                table: "BookItem",
                column: "FileFormatID");

            migrationBuilder.CreateIndex(
                name: "IX_BookItem_FormID",
                table: "BookItem",
                column: "FormID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecommendedBooks_BookItemID",
                table: "RecommendedBooks",
                column: "BookItemID");

            migrationBuilder.CreateIndex(
                name: "IX_Rental_BookItemID",
                table: "Rental",
                column: "BookItemID");

            migrationBuilder.CreateIndex(
                name: "IX_Rental_RentalStatusID",
                table: "Rental",
                column: "RentalStatusID");

            migrationBuilder.CreateIndex(
                name: "IX_Rental_RentalTypeID",
                table: "Rental",
                column: "RentalTypeID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipping_ShippingStatusID",
                table: "Shipping",
                column: "ShippingStatusID");

            migrationBuilder.CreateIndex(
                name: "IX_StockAmount_BookItemID",
                table: "StockAmount",
                column: "BookItemID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Supply_DeliveryStatusID",
                table: "Supply",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRecommendedBooks_BookItemID",
