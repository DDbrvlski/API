...
namespace BookStoreAPI.Controllers.Products.BookItems.Helpers
{
    public static class BookItemFiltersExtensions
    {
        public static IQueryable<BookItem> ApplyFilters(this IQueryable<BookItem> query, BookItemsWWWStoreFiltersForView filters)
        {
            if (filters == null)
                return query;
